...
- 역시 단순해보이는 것도 코드로 쓰려면 하나하나 굉장히 복잡하구나!
코드들이 많이 중복되는데 이런 것들을 고치고싶다. 당장은 어떻게 해야할 지 모르겠지만
조금 더 효율적인 방법으로 스타일도 먹이고 코드를 작성하고싶다!

### 3.지금까지 작업물 (사진)
    
- 처음으로 만들어본 페이지 ! 아직 손대야할 부분이 많지만, 그래도 한 것에 의의를 두고 시작한다.
<a href="https://ibb.co/yfpLCZz"><img src="https://i.ibb.co/gjds8f0/IMG-3578.png" alt="IMG-3578" border="0"></a>
